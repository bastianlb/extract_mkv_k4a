...
#      NAME: Pascal Volta Turing
#      NUM: Any number. Only those pairs are currently accepted by NVCC though:
#            5.0 5.2 6.0 6.2 7.0 7.2 7.5
...
if(CUDA_VERSION VERSION_GREATER_EQUAL "7.0" AND CUDA_VERSION VERSION_LESS "11.0")
...
if(CUDA_VERSION VERSION_GREATER_EQUAL "11.0")
  list(APPEND CUDA_KNOWN_GPU_ARCHITECTURES "A100")
  list(APPEND CUDA_ALL_GPU_ARCHITECTURES "8.0" "8.0+PTX")
endif()

if(CUDA_VERSION VERSION_GREATER_EQUAL "11.1")
  list(APPEND CUDA_KNOWN_GPU_ARCHITECTURES "Ampere")
  list(APPEND CUDA_COMMON_GPU_ARCHITECTURES "8.6" "8.6+PTX")
  list(APPEND CUDA_ALL_GPU_ARCHITECTURES "8.6" "8.6+PTX")
endif()
  ...
  foreach(arch_name ${CUDA_ARCH_LIST})
    ...
    if(arch_name MATCHES "^([0-9]\\.[0-9](\\([0-9]\\.[0-9]\\))?)$")
      ...
      elseif(${arch_name} STREQUAL "Turing")
        set(arch_bin 7.5)
        set(arch_ptx 7.5)
      elseif(${arch_name} STREQUAL "A100")
        set(arch_bin 8.0)
        set(arch_ptx 8.0)
