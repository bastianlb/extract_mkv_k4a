...
CUDACXX=/usr/local/cuda-${CUDA_VERSION}/bin/nvcc cmake .. -DCMAKE_BUILD_TYPE=Debug -DCMAKE_C_COMPILER=gcc-7 -DCMAKE_CXX_COMPILER=g++-7 -DCMAKE_EXPORT_COMPILE_COMMANDS=ON -DWITH_PCPD=ON -DPCPD_DIR=/data/develop/pcpd/
